...
// include: /tmp/tmpjtcnt12g.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/mandelbrot.data';
      var REMOTE_PACKAGE_BASE = 'mandelbrot.data';
...
Module['FS_createPath']("/src", "shaders", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build/mandelbrot.data');

      };
      Module['addRunDependency']('datafile_build/mandelbrot.data');
    ...
    loadPackage({"files": [{"filename": "/src/shaders/mb.fs", "start": 0, "end": 2727}, {"filename": "/src/shaders/mb.vs", "start": 2727, "end": 2926}], "remote_package_size": 2926});

  })();

// end include: /tmp/tmpjtcnt12g.js
// include: /tmp/tmpr9c2frw2.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpr9c2frw2.js
// include: /tmp/tmphd_m1kjz.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach(function(task) {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmphd_m1kjz.js
...
var ___start_em_js = Module['___start_em_js'] = 146192;
var ___stop_em_js = Module['___stop_em_js'] = 146292;
